...
<body>
    ...
    <div class="col-md-12">
        <div class="container">
            ...
            <h4>(Cadastrar Atividade) Selecione a disciplina:</h4>
            <?php while($qr = mysqli_fetch_assoc($result)){
                ...
                $dnome = $qrd['nome'];
                echo "<div class='mt-4'><a href='http://localhost/templates/professor/criarAtividade.php?idpd=".$idpd."&idd=".$id_disc."' class='link-disc' ><div>".$dnome." - curso (".$nomecurso.")
                </div></a>
                <form action='editAtividade.php' method='GET'>
                <input name='idpd' style='display: none;' value='".$idpd."'>
                <button class='btn btn-outline-dark'> Visualizar as atividades </button> 
                </form> <a href='http://localhost/templates/professor/criarAtividade.php?idpd=".$idpd."&idd=".$id_disc."'> <button class='btn btn-dark mt-1'> Criar atividade </button> </a>
                ";
