...
<style>
    ...
    .background{
        background-color: rgb(128, 126, 233);
    }

</style>
<nav class="navbar navbar-expand-md background navbar-dark" style="position:float;">

    <div class="navbar-brand ms-3"> <a href="http://localhost/templates/adm/admenu.php" style="text-decoration: none; color: White"> Myschool</a></div>
